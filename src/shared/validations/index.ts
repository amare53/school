...
export const userSchema = z.object({
  ...
  role: z.enum(['platform_admin', 'school_manager', 'cashier', 'accountant', 'student'], {
...
export const schoolSchema = z.object({
  ...
  subscriptionPlan: z
    .string()
    .min(1, 'Le plan d\'abonnement est requis'),
  currency: z
    .enum(['CDF', 'USD'], {
...
export const bulkBillingSchema = z.object({
  target: z
    .enum(['school', 'level', 'section', 'class'], {
