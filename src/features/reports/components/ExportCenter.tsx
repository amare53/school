...
const ExportCenter: React.FC = () => {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const fileName = `rapports_${currentSchool?.name.replace(/\s+/g, "_")}_${
            ...
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Badge variant="info" size="sm">
                  {reports.filter((r) => selectedReports.includes(r.id)).length}
                  /{reports.length}
                </Badge>
              </CardTitle>
            </CardHeader>
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {/* {formatDate(export_.date)} • {export_.format} •{" "} */}
                    {export_.size}
                  </p>
                </div>
                <div className="flex items-center space-x-2">
