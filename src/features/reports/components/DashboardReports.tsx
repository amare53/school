  ...
  const monthlyData = [
    {
      ...
      expenses: totalExpenses * 0.12,
    },
    {
      month: "Fév",
      revenue: totalRevenue * 0.18,
      expenses: totalExpenses * 0.15,
    },
    {
      month: "Mar",
      revenue: totalRevenue * 0.22,
      expenses: totalExpenses * 0.18,
    },
    {
      month: "Avr",
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">
                  {invoices.length > 0
                    ? Math.round((payments.length / invoices.length) * 100)
                    : 0}
                  %
                </p>
                ...
                <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                  <div className="flex items-center">
                    ...
                    <span className="font-medium text-yellow-900">
                      {expenses.filter((e) => !e.receiptUrl).length} dépense(s)
                      sans justificatif
                    </span>
                  </div>
